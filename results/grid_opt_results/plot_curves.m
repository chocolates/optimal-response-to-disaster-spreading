...
load('grid_S1_X.dat', '-mat');
strategy1 = X;


load('grid_S2_X.dat', '-mat');
strategy2 = X;

load('grid_S3_X.dat', '-mat');
strategy3 = X;

load('grid_S4_X.dat', '-mat');
strategy4 = X;

load('grid_S5_X.dat', '-mat');
strategy5 = X;

load('grid_S6_X.dat', '-mat');
strategy6 = X;

load('grid_op_sigmoid_obj_X.dat', '-mat');
strategy_obj_sigmoid = X;

load('grid_op_linear_obj_X.dat', '-mat');
...
if plot_type == 1
    ...
    print(gcf,'-dpdf','Grid_finalState.pdf')
end