...
strategy5 = csvread('average_curve_S5.dat');
...
h5 = plot(timesteps, strategy5);
h6 = plot(timesteps, strategy6);
legend([h0, h1,h2,h3,h4, h5,h6],'strategy0','strategy1','strategy2','strategy3','strategy4', 'strategy5', 'strategy6');
title('Grid Network', 'FontSize',18)
xlabel('time horizon','FontSize',16)
ylabel('damaged nodes', 'FontSize',16)

print(gcf,'-dpdf','GridNet.pdf')